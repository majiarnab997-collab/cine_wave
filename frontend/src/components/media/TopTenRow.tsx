...
export const TopTenRow: React.FC<TopTenRowProps> = ({
  title = 'Top 10 Today on CineWave',
  items,
  onOpenDetails,
  className = ''
}) => {
          ...
          {items.slice(0, 10).map((item, index) => {
            ...
            return (
              <div key={item.id} className="flex items-center shrink-0">
                ...
                <div className="relative -mr-5 sm:-mr-7 select-none z-10">
                  <span
                    className="font-display font-black text-6xl sm:text-7xl md:text-8xl tracking-tighter leading-none text-transparent stroke-white"
                    style={{
